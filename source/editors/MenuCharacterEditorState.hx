...
class MenuCharacterEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		DiscordClient.changePresence("Creating or editing menu character", 'Editing: ${characterFile.image}');
		#end
	...
	function reloadSelectedCharacter() {
		...
		#if DISCORD_ALLOWED
		// Updating Discord Rich Presence
		DiscordClient.changePresence("Creating menu character or editin it.", 'Editing: ${characterFile.image}');
		#end
	}
