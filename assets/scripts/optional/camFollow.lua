...
local xx = 532; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
...
local xx2 = 800; -- Same code as above, but for boyfriend left, right
local yy2 = 550; -- Same code as above, but for boyfriend up, down
local xx3 = 515; -- Same code as above, but for girlfriend left, right
